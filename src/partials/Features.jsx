  ...
  return (
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20 imageBackgroundCats">
          
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Consejos útiles</h1>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                ...
                <p className="text-xl text-gray-600">¡Tips generales para cuidar a tu hermoso michi!</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">¡Mantené a tu gato feliz!</div>
                    <div className="text-gray-600">Tips para que tu gato no se aburra y esté feliz.</div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">La función de la red es para que los gatos no se escapen y se puedan extraviar.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Guía básica y rápida para cuidar lactantes.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
